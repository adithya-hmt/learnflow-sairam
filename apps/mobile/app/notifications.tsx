...
export default function NotificationsScreen() {
  ...
  const markRead = async (id: string) => { try { await repository.markNotificationRead(id); await queryClient.invalidateQueries({ queryKey: queryKeys.notifications }); } catch { /* keep unread when the server cannot be reached */ } };
